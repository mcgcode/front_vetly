  ...
  return (
    <aside className='w-full h-auto md:w-80 md:h-full'>
      <div className='h-full px-3 py-4 rounded-lg shadow-lg'>
        <h3
          className='text-xl font-bold border-b-1 cursor-pointer flex items-center categories-title'
            ...
            {categories.map((category) => (
              <li key={category.id}>
                <button
                  ...
                  className='w-full flex items-center p-1 text-gray-900 rounded-lg hover:bg-gradient-to-br from-purple-600 to-blue-500 hover:text-white'
                >
                  {category.icon}
